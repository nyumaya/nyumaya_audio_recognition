...
if system == "Darwin":
	...
	play_command = "aplay"
	if(machine == "x86_64"):
		default_libpath = '../../lib/linux_x86_64/libnyumaya_premium.so.2.2.0'
	elif(machine == "armv6l"):
		default_libpath = '../../lib/rpi/armv6/libnyumaya_premium.so.2.2.0'
	elif(machine == "armv7l"):
		default_libpath = '../../lib/rpi/armv7/libnyumaya_premium.so.2.2.0'
	else:
