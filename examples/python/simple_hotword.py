...
def detectKeywords(libpath):
	...
	keywordIdFirefox = detector.addModel('../../models/Hotword/firefox_hotword.premium',0.6)
	keywordIdSheila = detector.addModel('../../models/Hotword/sheila_hotword.premium',0.6)
	keywordIdMarvin = detector.addModel('../../models/Hotword/marvin_hotword.premium',0.6)
	keywordIdAlexa = detector.addModel('../../models/Hotword/alexa_hotword.premium',0.6)
